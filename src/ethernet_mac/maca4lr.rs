...
pub type R = crate::R<MACA4LR_SPEC>;
#[doc = "Register `MACA4LR` writer"]
pub type W = crate::W<MACA4LR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addl(&mut self) -> ADDL_W<MACA4LR_SPEC> {
        ADDL_W::new(self, 0)
    }
...
#[doc = "Ethernet MAC address4 low register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`maca4lr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`maca4lr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
