...
#[doc = "Field `ADDL` reader - MAC address 2 low \\[31:0\\]"]
pub type ADDL_R = crate::FieldReader<u32>;
#[doc = "Field `ADDL` writer - MAC address 2 low \\[31:0\\]"]
pub type ADDL_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - MAC address 2 low \\[31:0\\]"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addl(&mut self) -> ADDL_W<MACA2LR_SPEC> {
        ADDL_W::new(self, 0)
    }
...
#[doc = "`reset()` method sets MACA2LR to value 0"]
