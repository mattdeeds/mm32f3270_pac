...
#[doc = "Field `ADDH` reader - MAC address1 high \\[47:32\\]"]
pub type ADDH_R = crate::FieldReader<u16>;
#[doc = "Field `ADDH` writer - MAC address1 high \\[47:32\\]"]
...
impl R {
    #[doc = "Bits 0:15 - MAC address1 high \\[47:32\\]"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addh(&mut self) -> ADDH_W<MACA1HR_SPEC> {
        ADDH_W::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    #[must_use]
    pub fn mbytec(&mut self) -> MBYTEC_W<MACA1HR_SPEC> {
        MBYTEC_W::new(self, 24)
    }
    #[doc = "Bit 30 - Source address"]
    #[inline(always)]
    #[must_use]
    pub fn sele(&mut self) -> SELE_W<MACA1HR_SPEC> {
        SELE_W::new(self, 30)
    }
    #[doc = "Bit 31 - Address enable"]
    #[inline(always)]
    #[must_use]
    pub fn adde(&mut self) -> ADDE_W<MACA1HR_SPEC> {
        ADDE_W::new(self, 31)
    }
...
#[doc = "`reset()` method sets MACA1HR to value 0"]
