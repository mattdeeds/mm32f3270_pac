...
#[doc = "Field `ADDH` reader - MAC address 2 high \\[47:32\\]"]
pub type ADDH_R = crate::FieldReader<u16>;
#[doc = "Field `ADDH` writer - MAC address 2 high \\[47:32\\]"]
...
#[doc = "Field `ADDE` reader - Address e"]
pub type ADDE_R = crate::BitReader;
#[doc = "Field `ADDE` writer - Address e"]
pub type ADDE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:15 - MAC address 2 high \\[47:32\\]"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addh(&mut self) -> ADDH_W<MACA2HR_SPEC> {
        ADDH_W::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    #[must_use]
    pub fn mbytec(&mut self) -> MBYTEC_W<MACA2HR_SPEC> {
        MBYTEC_W::new(self, 24)
    }
    #[doc = "Bit 30 - Source address"]
    #[inline(always)]
    #[must_use]
    pub fn sele(&mut self) -> SELE_W<MACA2HR_SPEC> {
        SELE_W::new(self, 30)
    }
    #[doc = "Bit 31 - Address e"]
    #[inline(always)]
    #[must_use]
    pub fn adde(&mut self) -> ADDE_W<MACA2HR_SPEC> {
        ADDE_W::new(self, 31)
    }
...
#[doc = "`reset()` method sets MACA2HR to value 0"]
