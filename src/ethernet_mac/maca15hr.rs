#[doc = "Register `MACA15HR` reader"]
pub type R = crate::R<MACA15HR_SPEC>;
#[doc = "Register `MACA15HR` writer"]
pub type W = crate::W<MACA15HR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addh(&mut self) -> ADDH_W<MACA15HR_SPEC> {
        ADDH_W::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    #[must_use]
    pub fn mbytec(&mut self) -> MBYTEC_W<MACA15HR_SPEC> {
        MBYTEC_W::new(self, 24)
    }
    #[doc = "Bit 30 - Source address"]
    #[inline(always)]
    #[must_use]
    pub fn sele(&mut self) -> SELE_W<MACA15HR_SPEC> {
        SELE_W::new(self, 30)
    }
    #[doc = "Bit 31 - Address enable"]
    #[inline(always)]
    #[must_use]
    pub fn adde(&mut self) -> ADDE_W<MACA15HR_SPEC> {
        ADDE_W::new(self, 31)
    }
...
#[doc = "Ethernet MAC address 15 high register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`maca15hr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`maca15hr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MACA15HR_SPEC;
impl crate::RegisterSpec for MACA15HR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`maca15hr::R`](R) reader structure"]
impl crate::Readable for MACA15HR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`maca15hr::W`](W) writer structure"]
impl crate::Writable for MACA15HR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MACA15HR to value 0"]
impl crate::Resettable for MACA15HR_SPEC {
