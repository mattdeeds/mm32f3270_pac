...
pub type R = crate::R<EP_CTL15_SPEC>;
#[doc = "Register `EP_CTL15` writer"]
pub type W = crate::W<EP_CTL15_SPEC>;
...
pub type EP_HSHK_15_R = crate::BitReader;
...
pub type HOST_WO_HUB_15_R = crate::BitReader;
...
pub type HOST_WO_HUB_15_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep_hshk_15(&mut self) -> EP_HSHK_15_W<EP_CTL15_SPEC> {
        EP_HSHK_15_W::new(self, 0)
    }
    #[doc = "Bit 1 - Any access to this endpoint will cause the otg_fs to return a stall handshake"]
    #[inline(always)]
    #[must_use]
    pub fn ep_stall_15(&mut self) -> EP_STALL_15_W<EP_CTL15_SPEC> {
        EP_STALL_15_W::new(self, 1)
    }
    #[doc = "Bit 2 - These three bits define whether the endpoint is enabled and the direction of the endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn ep_tx_en_15(&mut self) -> EP_TX_EN_15_W<EP_CTL15_SPEC> {
        EP_TX_EN_15_W::new(self, 2)
    }
    #[doc = "Bit 3 - These three bits define whether the endpoint is enabled and the direction of the endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn ep_rx_en_15(&mut self) -> EP_RX_EN_15_W<EP_CTL15_SPEC> {
        EP_RX_EN_15_W::new(self, 3)
    }
    #[doc = "Bit 4 - These three bits define whether the endpoint is enabled and the direction of the endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn ep_ctl_dis_15(&mut self) -> EP_CTL_DIS_15_W<EP_CTL15_SPEC> {
        EP_CTL_DIS_15_W::new(self, 4)
    }
    #[doc = "Bit 6 - This is a bit for master mode only and exists only in the control register of endpoint 0"]
    #[inline(always)]
    #[must_use]
    pub fn retry_dis_15(&mut self) -> RETRY_DIS_15_W<EP_CTL15_SPEC> {
        RETRY_DIS_15_W::new(self, 6)
    }
    #[doc = "Bit 7 - This is a bit for master mode only and exists only in the control endpt0_rg register of endpoint 0."]
    #[inline(always)]
    #[must_use]
    pub fn host_wo_hub_15(&mut self) -> HOST_WO_HUB_15_W<EP_CTL15_SPEC> {
        HOST_WO_HUB_15_W::new(self, 7)
    }
...
#[doc = "Endpoint control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ep_ctl15::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ep_ctl15::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
