...
pub type R = crate::R<TCBLKCNTR_SPEC>;
#[doc = "Register `TCBLKCNTR` writer"]
pub type W = crate::W<TCBLKCNTR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<TCBLKCNTR_SPEC> {
        CNT_W::new(self, 0)
    }
...
#[doc = "Data block count register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tcblkcntr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tcblkcntr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
