...
pub type R = crate::R<CMD_BUF0_SPEC>;
#[doc = "Register `CMD_BUF0` writer"]
pub type W = crate::W<CMD_BUF0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dat(&mut self) -> DAT_W<CMD_BUF0_SPEC> {
        DAT_W::new(self, 0)
    }
...
#[doc = "CMD buffer register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cmd_buf0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cmd_buf0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
