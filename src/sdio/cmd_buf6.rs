...
pub type R = crate::R<CMD_BUF6_SPEC>;
#[doc = "Register `CMD_BUF6` writer"]
pub type W = crate::W<CMD_BUF6_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dat(&mut self) -> DAT_W<CMD_BUF6_SPEC> {
        DAT_W::new(self, 0)
    }
...
#[doc = "CMD buffer register 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cmd_buf6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cmd_buf6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
