...
pub type R = crate::R<CH13DR_SPEC>;
...
#[doc = "Channel 13 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch13dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
