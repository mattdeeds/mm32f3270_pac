...
pub type R = crate::R<CH11DR_SPEC>;
...
#[doc = "Channel 11 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch11dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
