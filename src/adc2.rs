...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ch12dr(&self) -> &CH12DR {
        &self.ch12dr
    }
    #[doc = "0x4c - Channel 13 data register"]
    #[inline(always)]
    pub const fn ch13dr(&self) -> &CH13DR {
        &self.ch13dr
    }
...
pub mod ch9dr;
#[doc = "CH10DR (r) register accessor: Channel 10 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch10dr::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch10dr`]
module"]
pub type CH10DR = crate::Reg<ch10dr::CH10DR_SPEC>;
#[doc = "Channel 10 data register"]
pub mod ch10dr;
#[doc = "CH11DR (r) register accessor: Channel 11 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch11dr::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch11dr`]
module"]
pub type CH11DR = crate::Reg<ch11dr::CH11DR_SPEC>;
#[doc = "Channel 11 data register"]
pub mod ch11dr;
#[doc = "CH12DR (r) register accessor: Channel 12 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch12dr::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch12dr`]
module"]
pub type CH12DR = crate::Reg<ch12dr::CH12DR_SPEC>;
#[doc = "Channel 12 data register"]
pub mod ch12dr;
#[doc = "CH13DR (r) register accessor: Channel 13 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch13dr::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch13dr`]
module"]
