...
#[doc = "Channel 3 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch3dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH3DR_SPEC;
impl crate::RegisterSpec for CH3DR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch3dr::R`](R) reader structure"]
impl crate::Readable for CH3DR_SPEC {}
#[doc = "`reset()` method sets CH3DR to value 0"]
impl crate::Resettable for CH3DR_SPEC {
