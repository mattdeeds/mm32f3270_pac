...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tim2(&mut self) -> TIM2_W<APB1RSTR_SPEC> {
        TIM2_W::new(self, 0)
    }
    #[doc = "Bit 1 - TIM3 reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim3(&mut self) -> TIM3_W<APB1RSTR_SPEC> {
        TIM3_W::new(self, 1)
    }
    #[doc = "Bit 2 - TIM4 reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim4(&mut self) -> TIM4_W<APB1RSTR_SPEC> {
        TIM4_W::new(self, 2)
    }
    #[doc = "Bit 3 - TIM5 reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim5(&mut self) -> TIM5_W<APB1RSTR_SPEC> {
        TIM5_W::new(self, 3)
    }
    #[doc = "Bit 4 - TIM6 reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim6(&mut self) -> TIM6_W<APB1RSTR_SPEC> {
        TIM6_W::new(self, 4)
    }
    #[doc = "Bit 5 - TIM7 reset"]
    #[inline(always)]
    #[must_use]
    pub fn tim7(&mut self) -> TIM7_W<APB1RSTR_SPEC> {
        TIM7_W::new(self, 5)
    }
    #[doc = "Bit 11 - Window watchdog reset"]
    #[inline(always)]
    #[must_use]
    pub fn wwdg(&mut self) -> WWDG_W<APB1RSTR_SPEC> {
        WWDG_W::new(self, 11)
    }
    #[doc = "Bit 14 - SPI2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn spi2(&mut self) -> SPI2_W<APB1RSTR_SPEC> {
        SPI2_W::new(self, 14)
    }
    #[doc = "Bit 15 - SPI3 reset"]
    #[inline(always)]
    #[must_use]
    pub fn spi3(&mut self) -> SPI3_W<APB1RSTR_SPEC> {
        SPI3_W::new(self, 15)
    }
    #[doc = "Bit 17 - UART2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart2(&mut self) -> UART2_W<APB1RSTR_SPEC> {
        UART2_W::new(self, 17)
    }
    #[doc = "Bit 18 - UART3 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart3(&mut self) -> UART3_W<APB1RSTR_SPEC> {
        UART3_W::new(self, 18)
    }
    #[doc = "Bit 19 - UART4 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart4(&mut self) -> UART4_W<APB1RSTR_SPEC> {
        UART4_W::new(self, 19)
    }
    #[doc = "Bit 20 - UART5 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart5(&mut self) -> UART5_W<APB1RSTR_SPEC> {
        UART5_W::new(self, 20)
    }
    #[doc = "Bit 21 - I2C1 reset"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1(&mut self) -> I2C1_W<APB1RSTR_SPEC> {
        I2C1_W::new(self, 21)
    }
    #[doc = "Bit 22 - I2C2 reset"]
    #[inline(always)]
    #[must_use]
    pub fn i2c2(&mut self) -> I2C2_W<APB1RSTR_SPEC> {
        I2C2_W::new(self, 22)
    }
    #[doc = "Bit 24 - CRS reset"]
    #[inline(always)]
    #[must_use]
    pub fn crs(&mut self) -> CRS_W<APB1RSTR_SPEC> {
        CRS_W::new(self, 24)
    }
    #[doc = "Bit 25 - CAN reset"]
    #[inline(always)]
    #[must_use]
    pub fn can(&mut self) -> CAN_W<APB1RSTR_SPEC> {
        CAN_W::new(self, 25)
    }
    #[doc = "Bit 27 - Backup interface reset"]
    #[inline(always)]
    #[must_use]
    pub fn bkp(&mut self) -> BKP_W<APB1RSTR_SPEC> {
        BKP_W::new(self, 27)
    }
    #[doc = "Bit 28 - Power interface reset"]
    #[inline(always)]
    #[must_use]
    pub fn pwr(&mut self) -> PWR_W<APB1RSTR_SPEC> {
        PWR_W::new(self, 28)
    }
    #[doc = "Bit 29 - DAC reset"]
    #[inline(always)]
    #[must_use]
    pub fn dac(&mut self) -> DAC_W<APB1RSTR_SPEC> {
        DAC_W::new(self, 29)
    }
    #[doc = "Bit 30 - UART7 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart7(&mut self) -> UART7_W<APB1RSTR_SPEC> {
        UART7_W::new(self, 30)
    }
    #[doc = "Bit 31 - UART8 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart8(&mut self) -> UART8_W<APB1RSTR_SPEC> {
        UART8_W::new(self, 31)
    }
