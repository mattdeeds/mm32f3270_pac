...
pub type R = crate::R<HSEDLY_SPEC>;
#[doc = "Register `HSEDLY` writer"]
pub type W = crate::W<HSEDLY_SPEC>;
#[doc = "Field `HSE_EQU_CNT` reader - *D0"]
pub type HSE_EQU_CNT_R = crate::FieldReader<u16>;
#[doc = "Field `HSE_EQU_CNT` writer - *D0"]
pub type HSE_EQU_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - *D0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hse_equ_cnt(&mut self) -> HSE_EQU_CNT_W<HSEDLY_SPEC> {
        HSE_EQU_CNT_W::new(self, 0)
    }
