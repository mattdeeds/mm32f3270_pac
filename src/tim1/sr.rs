...
pub type COMIF_W<'a, REG> = crate::BitWriter0C<'a, REG>;
...
pub type BIF_W<'a, REG> = crate::BitWriter0C<'a, REG>;
...
pub type CC5IF_W<'a, REG> = crate::BitWriter0C<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc5if(&mut self) -> CC5IF_W<SR_SPEC> {
        CC5IF_W::new(self, 16)
    }
...
impl crate::Writable for SR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0001_1eff;
