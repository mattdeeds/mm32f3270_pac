...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr1fall(&mut self) -> CCR1FALL_W<CCR1FALL_SPEC> {
        CCR1FALL_W::new(self, 0)
    }
...
#[doc = "pwm shift count CCR1 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ccr1fall::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ccr1fall::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
