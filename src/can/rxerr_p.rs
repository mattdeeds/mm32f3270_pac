...
pub type R = crate::R<RXERR_P_SPEC>;
#[doc = "Register `RXERR_P` writer"]
pub type W = crate::W<RXERR_P_SPEC>;
...
pub type RXERR_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxerr(&mut self) -> RXERR_W<RXERR_P_SPEC> {
        RXERR_W::new(self, 0)
    }
...
#[doc = "Peli RX Error Counter register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rxerr_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rxerr_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
