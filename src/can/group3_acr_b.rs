...
pub type R = crate::R<GROUP3_ACR_B_SPEC>;
#[doc = "Register `GROUP3_ACR_B` writer"]
pub type W = crate::W<GROUP3_ACR_B_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AC_W<GROUP3_ACR_B_SPEC> {
        AC_W::new(self, 0)
    }
...
#[doc = "Basic Acceptance Code register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`group3_acr_b::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`group3_acr_b::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
