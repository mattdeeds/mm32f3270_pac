...
pub type R = crate::R<TXDR0_B_SPEC>;
#[doc = "Register `TXDR0_B` writer"]
pub type W = crate::W<TXDR0_B_SPEC>;
#[doc = "Field `TXDR0` reader - Transmit data register"]
pub type TXDR0_R = crate::FieldReader<u32>;
#[doc = "Field `TXDR0` writer - Transmit data register"]
pub type TXDR0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txdr0(&mut self) -> TXDR0_W<TXDR0_B_SPEC> {
        TXDR0_W::new(self, 0)
    }
...
#[doc = "Basic TX Data register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txdr0_b::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txdr0_b::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
