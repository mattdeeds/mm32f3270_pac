...
pub type R = crate::R<GROUP15_ACR0_P_SPEC>;
#[doc = "Register `GROUP15_ACR0_P` writer"]
pub type W = crate::W<GROUP15_ACR0_P_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AC_W<GROUP15_ACR0_P_SPEC> {
        AC_W::new(self, 0)
    }
