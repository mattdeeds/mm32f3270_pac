...
pub type R = crate::R<GROUP1_ACR2_P_SPEC>;
#[doc = "Register `GROUP1_ACR2_P` writer"]
pub type W = crate::W<GROUP1_ACR2_P_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ac(&mut self) -> AC_W<GROUP1_ACR2_P_SPEC> {
        AC_W::new(self, 0)
    }
