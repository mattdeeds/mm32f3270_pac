...
pub type R = crate::R<GROUP15_AMR_B_SPEC>;
#[doc = "Register `GROUP15_AMR_B` writer"]
pub type W = crate::W<GROUP15_AMR_B_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn am(&mut self) -> AM_W<GROUP15_AMR_B_SPEC> {
        AM_W::new(self, 0)
    }
...
#[doc = "Basic Acceptance Mask register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`group15_amr_b::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`group15_amr_b::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
