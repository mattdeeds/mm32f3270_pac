...
pub type R = crate::R<TXDATA7_P_SPEC>;
#[doc = "Register `TXDATA7_P` writer"]
pub type W = crate::W<TXDATA7_P_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data7(&mut self) -> DATA7_W<TXDATA7_P_SPEC> {
        DATA7_W::new(self, 0)
    }
...
#[doc = "Peli TX Data register 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`txdata7_p::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txdata7_p::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
