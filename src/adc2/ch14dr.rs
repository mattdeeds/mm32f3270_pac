...
pub type R = crate::R<CH14DR_SPEC>;
...
#[doc = "Channel 14 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch14dr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH14DR_SPEC;
impl crate::RegisterSpec for CH14DR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch14dr::R`](R) reader structure"]
impl crate::Readable for CH14DR_SPEC {}
#[doc = "`reset()` method sets CH14DR to value 0"]
impl crate::Resettable for CH14DR_SPEC {
