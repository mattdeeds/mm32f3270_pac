...
pub type R = crate::R<COMP1_POLL_SPEC>;
#[doc = "Register `COMP1_POLL` writer"]
pub type W = crate::W<COMP1_POLL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<COMP1_POLL_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Comparator 1 polling channel"]
    #[inline(always)]
    #[must_use]
    pub fn ch(&mut self) -> CH_W<COMP1_POLL_SPEC> {
        CH_W::new(self, 1)
    }
    #[doc = "Bit 2 - Comparator 1 Polling inverting input fix"]
    #[inline(always)]
    #[must_use]
    pub fn fixn(&mut self) -> FIXN_W<COMP1_POLL_SPEC> {
        FIXN_W::new(self, 2)
    }
    #[doc = "Bits 4:6 - Comparator 1 polling wait cycle"]
    #[inline(always)]
    #[must_use]
    pub fn period(&mut self) -> PERIOD_W<COMP1_POLL_SPEC> {
        PERIOD_W::new(self, 4)
    }
...
#[doc = "COMP1 Polling Output Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`comp1_poll::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`comp1_poll::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
