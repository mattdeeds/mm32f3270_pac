...
pub type R = crate::R<COMP2_CSR_SPEC>;
#[doc = "Register `COMP2_CSR` writer"]
pub type W = crate::W<COMP2_CSR_SPEC>;
...
#[doc = "Field `OUT` reader - Comparator 2 output status"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<COMP2_CSR_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Comparator 2 mode"]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> MODE_W<COMP2_CSR_SPEC> {
        MODE_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Comparator 2 inverting input selection"]
    #[inline(always)]
    #[must_use]
    pub fn inm_sel(&mut self) -> INM_SEL_W<COMP2_CSR_SPEC> {
        INM_SEL_W::new(self, 4)
    }
    #[doc = "Bits 7:8 - Comparator 2 normal phase input selection"]
    #[inline(always)]
    #[must_use]
    pub fn inp_sel(&mut self) -> INP_SEL_W<COMP2_CSR_SPEC> {
        INP_SEL_W::new(self, 7)
    }
    #[doc = "Bits 10:13 - Comparator 2 output selection"]
    #[inline(always)]
    #[must_use]
    pub fn out_sel(&mut self) -> OUT_SEL_W<COMP2_CSR_SPEC> {
        OUT_SEL_W::new(self, 10)
    }
    #[doc = "Bit 15 - Comparator 2 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> POL_W<COMP2_CSR_SPEC> {
        POL_W::new(self, 15)
    }
    #[doc = "Bits 16:17 - Comparator 2 hysteresis"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HYST_W<COMP2_CSR_SPEC> {
        HYST_W::new(self, 16)
    }
    #[doc = "Bits 18:20 - Comparator 2 output filter"]
    #[inline(always)]
    #[must_use]
    pub fn oflt(&mut self) -> OFLT_W<COMP2_CSR_SPEC> {
        OFLT_W::new(self, 18)
    }
    #[doc = "Bit 31 - Comparator 2 lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<COMP2_CSR_SPEC> {
        LOCK_W::new(self, 31)
    }
